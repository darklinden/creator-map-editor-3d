import { _decorator, Component, input, Input, EventKeyboard, KeyCode, Vec3, Mat4, EventMouse, Vec2, Quat, Node, isValid, Camera, director } from "cc";
...
export class CameraMoveDebug extends Component {
    ...
    protected onKeyDown(event: EventKeyboard) {
        // console.log('CameraMoveDebug.onKeyDown', event.keyCode);
    ...
    protected onKeyUp(event: EventKeyboard) {
        // console.log('CameraMoveDebug.onKeyUp', event.keyCode);
    ...
    protected _lastMouse: Vec2 = null;
    protected _yawPitchRoll: Quat = new Quat();
    protected _tempRotationZ: Quat = new Quat();
