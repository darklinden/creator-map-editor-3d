...
namespace pathfinding {
    ...
    export class AStar {
        ...
        private static _defaultFinder: AStar = null;
        public static get defaultFinder(): AStar {
            this._defaultFinder = this._defaultFinder || new AStar();
            return this._defaultFinder;
        }
    ...
    export const astar: AStar = AStar.defaultFinder;
}
